<div class="">
    <a href="" class="btn btn-default btn-rounded mb-4" data-bs-toggle="modal"
        data-bs-target="#modalLoginForm<?= $obj->id_ftype ?>">Edit</a>
</div>
<form action="" method="post">
    <div class="modal fade" id="modalLoginForm<?= $obj->id_ftype ?>" data-bs-keyboard="false" data-bs-backdrop="static"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body mx-3">
                    <div class="md-form ">
                        <input type="text" value="<?= $obj -> name_mtype?>" id="defaultForm-email" name="name_type"
                            class="form-control validate">
                        <label data-error="wrong" data-success="right" for="defaultForm-email">Name Type</label>
                        <input type="hidden" name="id_type" value="<?=  $obj -> id_mtype?>">
                    </div>
                </div>
